package com.anand.user.service.config;

import com.anand.user.service.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    // These two are used to create the object for restTemplate
    @Autowired
